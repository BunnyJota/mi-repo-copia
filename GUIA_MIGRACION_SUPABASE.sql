...
-- Luego haz click en "Run" para ejecutarlo
-- ============================================
...
CREATE INDEX idx_appointments_barbershop_start ON public.appointments(barbershop_id, start_at);
...
-- Función para obtener barbershop_id del usuario
...
-- Función para verificar pertenencia a barbershop
...
CREATE POLICY "Owners can insert own role" ON public.user_roles
...
CREATE POLICY "Authenticated can insert availability rules" ON public.availability_rules
  FOR INSERT TO authenticated WITH CHECK (true);

-- STAFF AVAILABILITY RULES POLICIES
...
-- PAYPAL WEBHOOK EVENTS POLICIES
...
-- ============================================
-- Si ves "Success" significa que todo se creó correctamente.
-- 
-- Próximos pasos:
-- 1. Configura las variables de entorno en tu app
